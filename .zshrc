...
# Copy to system (Wayland) clipboard
copy-to-clipboard() {
	zle vi-yank
	print -rn -- "$CUTBUFFER" | wl-copy
}

bindkey -M vicmd 'y' copy-to-clipboard
zle -N copy-to-clipboard

# Paste from system (Wayland) clipboard
# After cursor.
paste-from-clipboard-before() {
  CURSOR=$(( CURSOR + 1 ))
  LBUFFER+=$(wl-paste)
}

zle -N paste-from-clipboard-before
bindkey -M vicmd 'p' paste-from-clipboard-before
